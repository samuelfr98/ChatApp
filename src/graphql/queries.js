...
`;
export const messagesByChat_room_id = /* GraphQL */ `
  query MessagesByChat_room_id(
    $chat_room_id: ID!
...
`;
export const messagesByUser_id = /* GraphQL */ `
  query MessagesByUser_id(
    $user_id: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelMessageFilterInput
    $limit: Int
